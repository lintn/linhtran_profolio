    ...
    <main className="min-h-screen bg-black">
          ...
          <div className="absolute bottom-0 left-0 right-0 z-10 p-4 md:p-6">
            <div className="grid grid-cols-12 items-end gap-6">
              ...
              <div className="col-span-12 lg:col-span-4">
                ...
                >
                  I build modern, high-performance web applications with a focus on clean architecture, scalability, and seamless user experience across platforms.
                </motion.p>
      ...
      <section className="bg-black px-4 py-16 md:px-6 md:py-24">
        <div className="mx-auto max-w-6xl rounded-2xl bg-[#101010] px-6 py-12 text-center md:rounded-[2rem] md:px-10 md:py-16">
          <div className="text-[10px] text-primary sm:text-xs">Visual arts</div>
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          >
            ...
            <motion.div
              ...
              animate={
                featuresInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.95 }
              }
              transition={{
                duration: 0.7,
                ease: [0.22, 1, 0.36, 1],
